...
int main(int argc, char** argv)
{
    ...
    {
        utils::logger::criticalMessage("Invalid startup of the application!");
        return -1;
    }
    ...
    else
    {
        ...
        std::unique_ptr<imageloader::TGAImage> image{std::move(std::get<imageloader::TGAImage*>(loadResult))};
        if(image)
        {
